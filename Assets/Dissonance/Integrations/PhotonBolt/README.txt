Dissonance Photon Bolt Integration
==================================

This package integrates Dissonance Voice Chat (https://assetstore.unity.com/packages/tools/audio/dissonance-voice-chat-70078?aid=1100lJDF) with the Photon Bolt Free (https://assetstore.unity.com/packages/tools/network/photon-bolt-free-127156?aid=1100lJDF). To use this package you must have purchased and installed Dissonance and Photon Bolt - **you will encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/PhotonBolt/Demo/Bolt Demo) demonstrates the basics of a voice chat session running in a Photon Bolt network session. Consult the readme file in the demo folder for details on how to run the demo and what features it demonstrates.
